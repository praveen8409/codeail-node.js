...
app.use(
    session({
      ...
      store: MongoStore.create({
        mongoUrl: 'mongodb+srv://codeial:codeial@cluster0.qd2uov1.mongodb.net/test?retryWrites=true&w=majority',//'mongodb://0.0.0.0/codeial_development', // Replace this with your actual MongoDB connection string
        autoRemove: 'disabled',
      }),
    })
  );
